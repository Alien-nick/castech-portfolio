        ...
        <div class="w-full lg:w-5/12 px-4">
          <div class="hero-content">
            ...
            <p class="text-base mb-8 max-w-[520px]">
              ...
              for small/medium/large businesses in
              <span
                class="text-green-400 font-bold no-underline hover:underline underline-offset-2 decoration-2 decoration-green-400">
                Guyana</span>. <br>
            </p>
        ...
        <div class="w-full lg:w-6/12 px-4">
          <div class="lg:text-right lg:ml-auto">
            <div class="relative inline-block z-10 pt-11 lg:pt-0">
              <img
                src="{{ url('/images/hero-1.webp') }}"
                alt="hero"
                class="max-w-full lg:ml-auto rounded"
              />
