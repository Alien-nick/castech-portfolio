...
<section id="contact" class="dark:bg-primary py-20 lg:py-[120px] overflow-hidden relative z-10">
   <div class="container">
       ...
       <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
         <div class="max-w-[570px] mb-12 lg:mb-0">
           ...
           <p class="text-base text-body-color dark:text-gray-200 leading-relaxed mb-9">
             If you feel our experience and skills fits your needs, feel free to contact us.
           </p>
           <div class="flex mb-8 max-w-[370px] w-full">
             ...
             <div class="w-full">
               ...
               <p class="text-base text-body-color dark:text-gray-300">enquires@castech.dev</p>
             </div>
           </div>
         </div>
       </div>
