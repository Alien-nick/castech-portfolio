...
<section id="contact" class="dark:bg-slate-800 py-20 lg:py-[120px] overflow-hidden relative z-10">
    <div class="container">
       <div class="flex flex-wrap lg:justify-between -mx-4">
          <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
             <div class="max-w-[570px] mb-12 lg:mb-0">
                ...
                <p class="text-base text-body-color dark:text-white leading-relaxed mb-9">
                   We are located at Lot 193 Phulwarie Street Better Hope, East Coast Demerara, Georgetown, Guyana.
                </p>
                <div class="flex mb-8 max-w-[370px] w-full">
                   ...
                   <div class="w-full">
                      <h4 class="font-bold text-dark dark:text-white text-xl mb-1">Our Location</h4>
                      <p class="text-base text-body-color">
                         193 Phulwarie Street Better Hope, East Coast Demerara, Georgetown, Guyana.
                      </p>
                   </div>
                </div>
                <div class="flex mb-8 max-w-[370px] w-full">
                   ...
                   <div class="w-full">
                      <h4 class="font-bold text-dark dark:text-white text-xl mb-1">Phone Number</h4>
                      <p class="text-base text-body-color">(+1)592-653-4516</p>
                   </div>
                </div>
                <div class="flex mb-8 max-w-[370px] w-full">
                   <div
                   ...
                   <div class="w-full">
                      <h4 class="font-bold text-dark dark:text-white text-xl mb-1">
                         Email Address
                      </h4>
                      <p class="text-base text-body-color">info@castech.dev</p>
                   </div>
                </div>
             </div>
          </div>
          <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
             <div class="bg-white dark:bg-gray-900 relative rounded-lg p-8 sm:p-12 shadow-lg">
                <form>
                   <div class="mb-6">
                      <input
                         type="text"
